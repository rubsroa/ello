  ...
  return (
    <footer className="border-t border-ivory/12 bg-night py-14 text-ivory sm:py-20">
      <div className="page-shell grid gap-12 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr]">
        ...
        <div className="text-sm font-light leading-6 text-ivory/72"><p className="eyebrow mb-3 text-brass">Contact</p><a href="tel:+41763850340" className="inline-flex min-h-11 items-center hover:text-ivory">+41 76 385 03 40</a></div>
        <div className="flex flex-col items-start text-sm font-light text-ivory/72 lg:items-end"><Link href="/contact" className="inline-flex min-h-11 min-w-11 items-center hover:text-ivory">Contact</Link><Link href="/confidentialite" className="inline-flex min-h-11 min-w-11 items-center hover:text-ivory">Confidentialité</Link><Link href="/admin" className="inline-flex min-h-11 min-w-11 items-center hover:text-ivory">Espace équipe</Link></div>
      </div>
