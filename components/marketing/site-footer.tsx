  ...
  return (
    <footer className="border-t border-ivory/12 bg-night py-12 text-ivory">
      <div className="page-shell grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="text-sm font-light leading-6 text-ivory/72"><p className="eyebrow mb-3 text-brass">Nous trouver</p><p>Rue du Midi 12<br />1207 Genève, Suisse</p></div>
